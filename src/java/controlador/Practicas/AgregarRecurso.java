...
public class AgregarRecurso extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            ...
            default:
                request.getRequestDispatcher("EditarPractica?"+idPractica).forward(request, response);
    ...
    private void GuardarPractica(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        request.getRequestDispatcher("EditarPractica?id="+idPractica).forward(request, response);
